...
export const metadata = {
  title: '서울대 의대 진학 순위 2026 - momwatching.com',
  description: '전국 고등학교 서울대 의과대학 합격자 순위를 확인하세요. 2026년 서울대 의대 진학 실적 데이터.',
};

export default async function SnuMedical2026Page() {
  const data: Database = await getData();
  const medicalSchools = getSnuMedicalSchools(data, '2026');
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="mb-4">
            <p className="text-gray-700 text-sm">
              <span className="font-semibold">데이터 연도:</span> 2026학년도
            </p>
            <p className="text-gray-700 text-sm">
