...
export const metadata = {
  title: '2024년 서울대 진학 순위 - momwatching.com',
  description: '2024학년도 전국 고등학교 서울대 합격자 순위. 수시, 정시 합격자 현황.',
};

export default async function Seoul2024Page() {
  const data: Database = await getData();
  const schools = getSchoolsByYear(data, '2024');
