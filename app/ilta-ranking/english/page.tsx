...
export const metadata: Metadata = {
  title: '영어 일타 강사 순위 Top 10 - 2026년 2월 | momwatching.com',
  description: '2026년 최신 영어 일타 강사 순위. 이명학, 조정식, 주혜연 등 Top 10 강사의 강의 스타일, 추천 대상, 수강평을 비교 분석합니다.',
  keywords: '일타강사, 영어강사, 이명학, 조정식, 주혜연, 메가스터디, 이투스, 대성마이맥, 수능영어'
}
...
async function getRankingData(): Promise<RankingData> {
  ...
  const filePath = path.join(process.cwd(), 'public/ilta-ranking/data/english_ranking_2026-02.json')
  const fileContent = fs.readFileSync(filePath, 'utf8')
  return JSON.parse(fileContent)
}

export default async function EnglishRankingPage() {
