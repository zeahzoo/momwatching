...
export const metadata: Metadata = {
  title: '수학 일타 강사 순위 Top 10 - 2026년 2월 | momwatching.com',
  description: '2026년 최신 수학 일타 강사 순위. 현우진, 정승제, 배성민 등 Top 10 강사의 강의 스타일, 추천 대상, 수강평을 비교 분석합니다.',
  keywords: '일타강사, 수학강사, 현우진, 정승제, 배성민, 메가스터디, 이투스, 대성마이맥, 수능수학'
}
...
async function getRankingData(): Promise<RankingData> {
  ...
  const filePath = path.join(process.cwd(), 'public/ilta-ranking/data/math_ranking_2026-02.json')
  const fileContent = fs.readFileSync(filePath, 'utf8')
  return JSON.parse(fileContent)
}

export default async function MathRankingPage() {
