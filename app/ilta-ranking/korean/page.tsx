...
export const metadata: Metadata = {
  title: '국어 일타 강사 순위 Top 10 - 2026년 2월 | momwatching.com',
  description: '2026년 최신 국어 일타 강사 순위. 윤혜정, 이원준, 장동준 등 Top 10 강사의 강의 스타일, 추천 대상, 수강평을 비교 분석합니다.',
  keywords: '일타강사, 국어강사, 윤혜정, 이원준, 장동준, 메가스터디, 이투스, EBSi, 수능국어'
}
...
async function getRankingData(): Promise<RankingData> {
  ...
  const filePath = path.join(process.cwd(), 'public/ilta-ranking/data/korean_ranking_2026-02.json')
