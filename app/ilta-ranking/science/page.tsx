...
export const metadata: Metadata = {
  title: '과학탐구 일타 강사 순위 Top 10 - 2026년 2월 | momwatching.com',
  description: '2026년 최신 과학탐구 일타 강사 순위. 변춘수, 양진석, 장동호 등 Top 10 강사의 강의 스타일, 추천 대상, 수강평을 비교 분석합니다.',
  keywords: '일타강사, 과탐강사, 변춘수, 양진석, 장동호, EBSi, 이투스, 물리, 화학, 생명과학, 지구과학'
}
...
async function getRankingData(): Promise<RankingData> {
  ...
  const filePath = path.join(process.cwd(), 'public/ilta-ranking/data/science_ranking_2026-02.json')
